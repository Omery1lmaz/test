...
var CTooltip = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(CConditionalPortal.CConditionalPortal, { container: container, portal: true },
            React.createElement(Transition.default, { in: _visible, mountOnEnter: true, nodeRef: tooltipRef, onEnter: function () {
                    ...
                    exit: tooltipRef.current
                        ? getTransitionDurationFromElement.default(tooltipRef.current) + 50
                        : 200,
                }, unmountOnExit: true }, function (state) { return (React.createElement("div", tslib_es6.__assign({ className: index.default('tooltip', 'bs-tooltip-auto', {
                    fade: animation,
                    show: state === 'entered',
